...
class BallsShareDialogAnimatedBuilder extends StatelessWidget {
  const BallsShareDialogAnimatedBuilder({
    Key? key,
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return builder(
          context,
          child,
          BallsShareDialogEnterAnimation(animation as AnimationController),
        );
      },
      child: child,
    );
...
typedef MyTransitionBuilder = Widget Function(
  ...
  Widget? child,
  BallsShareDialogEnterAnimation animation,
);

class BallsShareDialogEnterAnimation {
  BallsShareDialogEnterAnimation(this.controller)
